...
const char* MissionController::_jsonGroundStationKey =          JsonHelper::jsonGroundStationKey;
...
bool MissionController::_loadJsonMissionFile(const QByteArray& bytes, QmlObjectListModel* visualItems, QmlObjectListModel* complexItems, QString& errorString)
{
    ...
    if (json.contains(JsonHelper::jsonVersionKey) && json[JsonHelper::jsonVersionKey].isString() && json[JsonHelper::jsonVersionKey].toString() == QStringLiteral("1.0")) {
...
bool MissionController::_loadJsonMissionFileV1(const QJsonObject& json, QmlObjectListModel* visualItems, QmlObjectListModel* complexItems, QString& errorString)
{
    ...
    QStringList requiredKeys(_jsonPlannedHomePositionKey);
    ...
    keyList << _jsonItemsKey << JsonHelper::jsonGroundStationKey << _jsonMavAutopilotKey << _jsonComplexItemsKey << _jsonPlannedHomePositionKey;
    typeList << QJsonValue::Array << QJsonValue::String << QJsonValue::Double << QJsonValue::Array << QJsonValue::Object;
